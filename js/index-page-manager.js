...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const initSearchModal = () => {
        ...
        const searchData = [
            ...
            { title: "Advanced Table", category: "display", url: "docs/components/advanced-table.html" },
            ...
            { title: "Call-to-Action", category: "display", url: "docs/components/cta.html" },
            ...
            { title: "Data List", category: "display", url: "docs/components/data-list.html" },
            ...
            { title: "Feature Grid", category: "display", url: "docs/components/feature-grid.html" },
            ...
            { title: "Masonry Layout", category: "display", url: "docs/components/masonry.html" },
            ...
            { title: "Playlist", category: "media", url: "docs/components/playlist.html" },
            { title: "Progress", category: "feedback", url: "docs/components/progress.html" },
            { title: "Rating", category: "display", url: "docs/components/rating.html" },
            ...
            { title: "Testimonial", category: "display", url: "docs/components/testimonial.html" },
            ...
            { title: "Video Player", category: "media", url: "docs/components/video-player.html" },
            { title: "Page Loader", category: "feedback", url: "docs/components/page-loader.html" },
            { title: "Back to Top", category: "navigation", url: "docs/components/back-to-top.html" },
            { title: "Bottom Sheet", category: "overlay", url: "docs/components/bottom-sheet.html" },
            { title: "Pie Menu", category: "navigation", url: "docs/components/pie-menu.html" },
            { title: "Multi Select", category: "forms", url: "docs/components/multi-select.html" },
            { title: "Calendar Picker", category: "forms", url: "docs/components/calendar-picker.html" },
            { title: "Lightbox", category: "overlay", url: "docs/components/lightbox.html" },
            { title: "2D Matrix", category: "display", url: "docs/components/matrix-2d.html" },
            { title: "Dial", category: "forms", url: "docs/components/dial.html" },
            { title: "Wheel Picker", category: "forms", url: "docs/components/wheel-picker.html" },
            { title: "Color Picker", category: "forms", url: "docs/components/color-picker.html" },
            { title: "Popover", category: "overlay", url: "docs/components/popover.html" },
            { title: "Ribbon Tab Bar", category: "navigation", url: "docs/components/ribbon-tab-bar.html" },
            { title: "Segmented Button", category: "forms", url: "docs/components/segmented-button.html" },
            { title: "Snackbar Toast", category: "feedback", url: "docs/components/snackbar-toast.html" },
            { title: "Split Menu", category: "navigation", url: "docs/components/split-menu.html" },
            { title: "State Switch", category: "forms", url: "docs/components/state-switch.html" },
            { title: "Vertical Toggle", category: "forms", url: "docs/components/vertical-toggle.html" },
            { title: "Treeview", category: "navigation", url: "docs/components/treeview.html" },
            { title: "Checkbox Tree Selector", category: "forms", url: "docs/components/checkbox-tree-selector.html" },
            { title: "Pie Chart", category: "display", url: "docs/components/pie-chart.html" },
            { title: "Venn Diagram", category: "display", url: "docs/components/venn-diagram.html" },
            { title: "Bar Chart", category: "display", url: "docs/components/bar-chart.html" },
            { title: "Audio Record Monitor Upload", category: "media", url: "docs/components/audio-record-monitor-upload.html" },
            { title: "Inbox Messaging", category: "display", url: "docs/components/inbox-messaging.html" },
            { title: "Logging Viewer", category: "display", url: "docs/components/logging.html" },
            { title: "Social Share Link Bar", category: "navigation", url: "docs/components/social-share-link-bar.html" },
