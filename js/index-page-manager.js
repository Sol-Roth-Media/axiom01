...
// 2. Theme Toggling (Header Toggle Button)
    ...
    const initSearchModal = () => {
        ...
        const searchData = [
            ...
            { title: "Swiping Card Interface", category: "interaction", url: "docs/components/swiping-card-interface.html" },
            { title: "Pull to Refresh", category: "interaction", url: "docs/components/pull-to-refresh.html" },
            { title: "Story View", category: "interaction", url: "docs/components/story-view.html" },
            { title: "Multimedia Picker", category: "forms", url: "docs/components/multimedia-picker.html" },
            { title: "Autocomplete", category: "forms", url: "docs/components/autocomplete.html" },
            { title: "Stopwatch and Countdown", category: "interaction", url: "docs/components/stopwatch-countdown.html" },
            { title: "Shapes and Paths", category: "display", url: "docs/components/shapes-paths.html" },
            { title: "Touch Components", category: "interaction", url: "docs/components/touch-components.html" },
            { title: "File Display and Download", category: "display", url: "docs/components/file-display-download.html" },
